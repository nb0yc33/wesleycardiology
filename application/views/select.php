<html>
	...
	* {
	...
	<div class="container">
        ...
        <div id="container3">
            <button type="button" class="collapsible" id="role-header">Radiographer Entry</button>
                <div class="content">
                    <?php echo validation_errors(); ?> 
            ...
            <div class="form-group">  
                <div id="addContainer">
                    <input type="submit" name="Add" value="Add Radiographer Entry" id="Add" class="btn btn-info" />  
                </div>
            </div>
        </div>
